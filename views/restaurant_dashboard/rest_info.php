...
require_once '../../models/rest_dashboard_model.php';

$userID = $_SESSION["user_id"];
$results = read_company_rests($pdo, $userID);
                ...
                <?php if ($results): ?>
                    <?php foreach ($results as $result): ?>
                        <div class="para">
                            ...
                            <p><span>Your Role : </span><?php echo strtoupper(htmlspecialchars($result['role'])); ?>AURANT</p>
                            </div>
                    <?php endforeach; ?>
                <?php else: ?>
