...
<body>
   ...
   <div class="landing" style ="margin-top:-29px">
    <div class="img-slider">
        ...
        <div class="slider">
            ...
            <div class="slide">
                <div class="title"><span>Ajloun</span> is a town in the fertile highlands of north Jordan. It’s overlooked by the ruined Ajloun Castle,
                    ...
                    The Prophet’s Trail continues through orchards and oak trees to the Ajloun Forest Reserve
                    <br>  <a href ="whereToGo_Ajloun.php">Explore More   <i class="fa-solid fa-magnifying-glass-location"></i></a></div>
            ...
            <div class="slide">
                <div class="title"><span>Amman</span>, the capital of Jordan, is a modern city with numerous ancient ruins. 
                    ...
                    the Roman Theater is a 6,000-capacity, 2nd-century stone amphitheater offering occasional events.
                    <br>  <a href ="whereToGo_amman.php">Explore More   <i class="fa-solid fa-magnifying-glass-location"></i></a>
                </div>
            ...
            <div class="slide">
                <div class="title"><span>Irbid</span> is a city in northern Jordan. In a 19th-century Ottoman castle,
                    ...
                    is now the Beit Arar cultural center.
                    <br>  <a href ="whereToGo_Irbid.php">Explore More   <i class="fa-solid fa-magnifying-glass-location"></i></a></div>
            ...
            <div class="slide">
                <div class="title">
                    ...
                    <br>  <a href ="whereToGo_Al-Kerak.php">Explore More   <i class="fa-solid fa-magnifying-glass-location"></i></a>
            </div>
        ...
        <div class="slide">
            <div class="title"><span>Ma`an</span> is one of the governorates of Jordan, it is located south of Amman, Jordan's capital.
                 Its capital is the city of Ma'an. This governorate is the largest in the kingdom of Jordan by area.
                 <br>  <a href ="whereToGo_Maan.php">Explore More   <i class="fa-solid fa-magnifying-glass-location"></i></a></div>
            ...
            <div class="title"> <span>Mafraq</span> was first settled in the 4th century BC.
                 It is located about 17 km west of the historic Nabataean and Byzantine town of Umm el-Jimal,
                  which was built in the 1st century. The city was first named "Fudain",
                   which comes from the word for fortress in Arabic.
                   <br>  <a href ="whereToGo_Mafraq.php">Explore More   <i class="fa-solid fa-magnifying-glass-location"></i></a></div>
            ...
            <div class="slide">
                <div class="title"><span>Aqaba</span> is a Jordanian port city on the Red Sea's Gulf of Aqaba. Inhabited since 4000 B.C.,
                     it's home to the Islamic-era Aqaba Fort. Its beach resorts are popular for windsurfing and other water sports,
                      ...
                      with notable dive sites including the Yamanieh coral reef in the Aqaba Marine Park, south of the city.
                      <br>  <a href ="whereToGo_Aqaba.php">Explore More   <i class="fa-solid fa-magnifying-glass-location"></i></a></div>
                 ...
                 Its significance as an Ottoman Empire trading hub is reflected in its Ottoman architecture.
                  The early-20th-century Abu Jaber mansion, now the Historic Old Salt Museum,
                   has Italian frescoed ceilings. An Ottoman mosque overlooks Hammam Street with its food market.
                    The Archaeological Museum focuses on finds from the Chalcolithic era (4500–3300 B.C.) to the 16th century.
                    <br>  <a href ="whereToGo_Mafraq.php">Explore More   <i class="fa-solid fa-magnifying-glass-location"></i></a></div>
            ...
            <div class="slide">
                <div class="title"><span>Petra</span> is half-built, half-carved into the rock,
                    ...
                    <br>  <a href ="whereToGo_Petra.php">Explore More   <i class="fa-solid fa-magnifying-glass-location"></i></a></div>
