        ...
        <i  class="fa-solid fa-sliders icon"></i>
          ...
          if(isset($_SESSION["user_id"])){?>
           ...
           <li><i class="fa-regular fa-envelope display"style = "display: flex;"></i><a href="contact.php">Content Us</a></li>
                ...
                <li><i class="fa-solid fa-user-gear" style = "display: flex;"></i><a href="views/user_dashboad/personal_info.php"><?php echo $_SESSION["user_username"]?></a></li>
           </div>
           <?php  }
else{
?>           <div class="displayedInSmall">
...
?>
       <li class="more" style="cursor: pointer;">More
            <div class="content">
              <ul class="displayLinks">
                <li style="margin-left: 27px;"><i class="fa-regular fa-envelope display"></i><a href="contact.php">Content Us</a></li>
                 <li style="margin-left: 27px;"><i class="fa-solid fa-user-plus display"></i><a href="signup.php">sign up</a></li>
                <li style="margin-left: 27px;"><i class="fa-solid fa-right-to-bracket display"></i></i><a href="login.php">Login</a></li>
...
<?php }?>
    ...
    if (window.scrollY === 0) {
        navbar.style.backgroundColor = '#ffffff5e';
    } else {
      navbar.style.backgroundColor = 'rgb(255, 255, 255, 0.52)';
