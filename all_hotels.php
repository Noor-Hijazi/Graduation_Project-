    ...
    ?>
        ...
        <?php
             if (isset($_SESSION["user_id"])) {
                echo '<form action="includes/whidhlist_all.inc.php" method="post">
            ...
            <button class="reservation-btn"><a href="htl-reservation.php?hotel_id=<?= $hotel['hotel_id'] ?>">Make A Reservation</a></button>
        </div>
    <?php 
        $count++;
    endforeach; 
