    ...
    <div class="reservation" style="margin-bottom: 100px;">
        <div class="continer">
            ...
            <form action="includes/car_rental.inc.php" method="post" enctype="multipart/form-data">
                ...
                <input type="text" name="location_from" placeholder="city-street"> 

                <label for="location_to">Location To:</label>
                <input type="text" name="location_to" placeholder="city-street"> 


                 <label for="payment_method">Payment Method:</label>
                <input type="text" name="payment_method" value ="Cash" disabled>
