...
function get_car_info(object $pdo , $carId){
    ...
    function insert_rental_car($pdo, $carId, $userId, $start_date, $end_date, $location_from, $location_to, $fileName, $imageData,$totalPrice) {
        ...
        try {
            ...
            $query = "INSERT INTO car_rental (carID, userID, start_date, end_date, location_from, location_to, filename, image_data,totalPrice) 
                      VALUES (:carId, :userId, :start_date, :end_date, :location_from, :location_to, :fileName, :imageData,:totalPrice)";
            $stmt = $pdo->prepare($query);
