...
function insert_into_guid($pdo, $name, $email, $experience, $language, $can_go, $photoName, $imageData) {
    $query = 'INSERT INTO guids (languages, experience, guid_name, img, img_data) VALUES (:languages, :experiences, :guid_name, :img, :img_data)';
...
function update_guide_info(PDO $pdo, int $guide_id, string $name, string $email, string $experience, string $language, string $can_go) {
    $query = 'UPDATE guids SET guid_name = :name, email = :email, experience = :experience, languages = :languages, can_go = :can_go WHERE guid_id = :guide_id';
